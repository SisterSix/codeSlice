 ...
 * <p/>
 * Remark   : 数字主键Hashtable
 * Use just like java.util.Hashtable, except that the keys must be ints. This is
...
public class IntHashtable
     ...
     * @param loadFactor a number between 0.0 and 1.0, it defines the threshold for
     *      rehashing the hashtable into a bigger one.
     * @throws IllegalArgumentException If the initial capacity is less than or equal
     *      to zero.
    ...
    /**
     * Returns an enumeration of the elements. Use the Enumeration methods on the returned
    ...
    /**
     * Returns true if the specified object is an element of the hashtable. This operation
     * is more expensive than the containsKey() method.
     *
     * @param value the value that we are looking for
     * @return Description of the Return Value
     * @throws NullPointerException If the value being searched for is equal to null.
     ...
     * @return Description of the Return Value
     * @returns the element for the key or null if the key is not defined in the hash
     *      table.
     ...
     *
     * @param okey Description of the Parameter
     * @return Description of the Return Value
     */
    ...
    /**
     * Puts the specified element into the hashtable, using the specified key. The element
     * may be retrieved by doing a get() with the same key.The key and the element cannot
     * be null.
     *
     * @param key the specified key in the hashtable
     * @param value the specified element
     * @return the old value of the key, or null if it did not have one.
     * @throws NullPointerException If the value of the element is equal to null.
    ...
    /**
     * Removes the element corresponding to the key. Does nothing if the key is not
     * present.
     *
    ...
    /**
     * Creates a clone of the hashtable. A shallow copy is made, the keys and elements
     * themselves are NOT cloned. This is a relatively expensive operation.
     *
     * @return Description of the Return Value
     */
